...
public interface IYieldMetadataWhenFalse<TModel, TMetadata, TUnderlyingMetadata> :
    IYieldMetadataWhenAllFalse<TModel, TMetadata, TUnderlyingMetadata>,
    IYieldMetadataWhenAnyFalse<TModel, TMetadata, TUnderlyingMetadata>
{
}