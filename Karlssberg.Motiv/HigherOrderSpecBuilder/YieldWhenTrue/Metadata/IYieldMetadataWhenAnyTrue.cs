...
public interface IYieldMetadataWhenAnyTrue<TModel, TMetadata, TUnderlyingMetadata> :
    IYieldTypeConvertedMetadataWhenAnyTrue<TModel, TUnderlyingMetadata>
{
    ...
    IYieldMetadataWhenFalse<TModel, TMetadata, TUnderlyingMetadata> YieldWhenAnyTrue(
