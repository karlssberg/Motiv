...
public readonly ref struct ExplanationWithPropositionSpecDecoratorSpecFactory<TModel, TUnderlyingMetadata>(
    ...
    string candidateProposition)
{
    ...
    public SpecBase<TModel, string> Create() =>
        new SpecDecoratorExplanationSpec<TModel,TUnderlyingMetadata>(
            spec,
            trueBecause,
            falseBecause,
