...
public readonly ref struct ExplanationMultiAssertionWithPropositionSpecDecoratorSpecFactory<TModel, TUnderlyingMetadata>(
    ...
    string candidateProposition)
{
    ...
    public SpecBase<TModel, string> Create(string proposition) =>
        new SpecDecoratorMultiMetadataSpec<TModel, string, TUnderlyingMetadata>(
            spec,
            trueBecause,
            falseBecause,
