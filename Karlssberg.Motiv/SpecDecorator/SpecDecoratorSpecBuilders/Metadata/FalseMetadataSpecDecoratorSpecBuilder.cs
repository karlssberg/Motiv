namespace Karlssberg.Motiv.SpecDecorator.SpecDecoratorSpecBuilders.Metadata;
...
public readonly ref struct FalseMetadataSpecDecoratorSpecBuilder<TModel, TMetadata, TUnderlyingMetadata>(
    ...
    Func<TModel, BooleanResultBase<TUnderlyingMetadata>, IEnumerable<TMetadata>> whenTrue)
{
    ...
    public MetadataSpecDecoratorSpecFactory<TModel, TMetadata, TUnderlyingMetadata> WhenFalse(
        TMetadata whenFalse) =>
        new(spec,
            whenTrue,
