...
public readonly ref struct MetadataSpecDecoratorSpecFactory<TModel, TMetadata, TUnderlyingMetadata>(
    ...
    Func<TModel, BooleanResultBase<TUnderlyingMetadata>, IEnumerable<TMetadata>> whenFalse)
{
    ...
    public SpecBase<TModel, TMetadata> Create(string proposition) =>
        new SpecDecoratorMultiMetadataSpec<TModel, TMetadata, TUnderlyingMetadata>(
            spec,
            whenTrue,
            whenFalse,
