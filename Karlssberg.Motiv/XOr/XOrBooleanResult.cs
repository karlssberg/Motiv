...
/// <summary>
/// Represents the result of a logical XOR (exclusive OR) operation.
/// </summary>
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="XOrBooleanResult{TMetadata}"/> class.
    /// </summary>
    ...
    /// <summary>
    /// Gets a value indicating whether the XOR operation is satisfied.
    /// </summary>
