    ...
    : ISpecDescription
{
    ...
    private string Summarize(SpecBase<TModel, TMetadata> operand)
    {
        ...
        {
            AndSpec<TModel, TMetadata> andSpec => andSpec.Description.Statement,
            AndAlsoSpec<TModel, TMetadata> andAlsoSpec => andAlsoSpec.Description.Statement,
    ...
    private string Explain(SpecBase<TModel, TMetadata> operand)
    {
        return operand switch
        {
            AndSpec<TModel, TMetadata> andSpec => andSpec.Description.Detailed,
            AndAlsoSpec<TModel, TMetadata> andAlsoSpec => andAlsoSpec.Description.Detailed,
