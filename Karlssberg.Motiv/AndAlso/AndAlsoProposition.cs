...
internal sealed class AndAlsoProposition<TModel, TMetadata>(
    ...
    : IProposition
{
    ...
    private string Summarize(SpecBase<TModel, TMetadata> operand)
    {
        return operand switch
        {
            ...
            AndAlsoSpec<TModel, TMetadata> andAlsoSpec => andAlsoSpec.Proposition.Statement,
    ...
    private string Explain(SpecBase<TModel, TMetadata> operand)
    {
        return operand switch
        {
            ...
            AndAlsoSpec<TModel, TMetadata> andAlsoSpec => andAlsoSpec.Proposition.Detailed,
