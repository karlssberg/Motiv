...
public readonly ref struct FalseMetadataSpecFactoryDecoratorSpecBuilder<TModel, TMetadata, TUnderlyingMetadata>(
    ...
    Func<TModel, BooleanResultBase<TUnderlyingMetadata>, IEnumerable<TMetadata>> whenTrue)
{
    ...
    /// <returns>An instance of <see cref="MetadataSpecFactoryDecoratorSpecFactory{TModel,TMetadata,TUnderlyingMetadata}" />.</returns>
    public MetadataSpecFactoryDecoratorSpecFactory<TModel, TMetadata, TUnderlyingMetadata> WhenFalse(
        TMetadata whenFalse) =>
        new(specPredicate,
            whenTrue,
