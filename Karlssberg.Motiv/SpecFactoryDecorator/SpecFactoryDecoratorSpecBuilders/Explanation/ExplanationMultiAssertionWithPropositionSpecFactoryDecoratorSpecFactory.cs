...
public readonly ref struct ExplanationMultiAssertionWithPropositionSpecFactoryDecoratorSpecFactory<TModel,
    TUnderlyingMetadata>(
    ...
    string candidateProposition)
{
    ...
    public SpecBase<TModel, string> Create() =>
        new SpecFactoryDecoratorMultiMetadataSpec<TModel, string, TUnderlyingMetadata>(
            specPredicate,
            trueBecause,
            falseBecause,
