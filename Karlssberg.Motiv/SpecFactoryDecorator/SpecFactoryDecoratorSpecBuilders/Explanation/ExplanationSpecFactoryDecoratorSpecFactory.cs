...
public readonly ref struct ExplanationSpecFactoryDecoratorSpecFactory<TModel, TUnderlyingMetadata>(
    ...
    Func<TModel, BooleanResultBase<TUnderlyingMetadata>, string> falseBecause)
{
    ...
    /// <returns>An instance of <see cref="SpecFactoryDecoratorExplanationSpec{TModel,TUnderlyingMetadata}" />.</returns>
    public SpecBase<TModel, string> Create(string proposition) =>
        new SpecFactoryDecoratorExplanationSpec<TModel, TUnderlyingMetadata>(
            specPredicate,
            trueBecause,
            falseBecause,
