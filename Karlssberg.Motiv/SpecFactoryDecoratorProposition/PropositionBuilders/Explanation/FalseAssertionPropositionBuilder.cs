    ...
    Func<TModel, BooleanResultBase<TUnderlyingMetadata>, string> trueBecause)
{
    ...
    /// <returns>An instance of <see cref="ExplanationSpecFactoryDecoratorPropositionFactory{TModel,TUnderlyingMetadata}" />.</returns>
    public ExplanationSpecFactoryDecoratorPropositionFactory<TModel, TUnderlyingMetadata> WhenFalse(string falseBecause) =>
        new(specPredicate,
            trueBecause,
            (_ ,_) => falseBecause);
    ...
    /// <returns>An instance of <see cref="ExplanationSpecFactoryDecoratorPropositionFactory{TModel,TUnderlyingMetadata}" />.</returns>
    public ExplanationSpecFactoryDecoratorPropositionFactory<TModel, TUnderlyingMetadata> WhenFalse(Func<TModel, string> falseBecause) =>
        new(specPredicate,
            trueBecause,
    ...
    /// <param name="falseBecause">A function that generates a human-readable reason when the condition is false.</param>
    /// <returns>An instance of <see cref="ExplanationSpecFactoryDecoratorPropositionFactory{TModel,TUnderlyingMetadata}" />.</returns>
    public ExplanationSpecFactoryDecoratorPropositionFactory<TModel, TUnderlyingMetadata> WhenFalse(
