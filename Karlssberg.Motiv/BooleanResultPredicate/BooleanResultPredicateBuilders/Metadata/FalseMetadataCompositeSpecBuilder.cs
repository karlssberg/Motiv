...
public readonly ref struct FalseMetadataBooleanResultPredicateSpecBuilder<TModel, TMetadata, TUnderlyingMetadata>(
    ...
    Func<TModel, BooleanResultBase<TUnderlyingMetadata>, IEnumerable<TMetadata>> whenTrue)
{
    ...
    public MetadataBooleanResultPredicateSpecFactory<TModel, TMetadata, TUnderlyingMetadata> WhenFalse(
        TMetadata whenFalse) =>
        new(predicate,
            whenTrue,
