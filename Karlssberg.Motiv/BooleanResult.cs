    ...
    TMetadata metadata) : BooleanResultBase<TMetadata>
{
    ...
    public override ResultDescriptionBase Description { get; } = new BooleanResultDescription(assertion);
...
public class BooleanResult(bool satisfied, string assertion) : BooleanResultBase<string>
{
    ...
    public override ResultDescriptionBase Description { get; } = new BooleanResultDescription(assertion);
    public override Explanation Explanation { get; } = new (assertion);
    public override IEnumerable<BooleanResultBase> Causes { get; } = Enumerable.Empty<BooleanResultBase>();
    public override IEnumerable<BooleanResultBase> Underlying { get; } = Enumerable.Empty<BooleanResultBase>();
    public override MetadataTree<string> MetadataTree { get; } = new(assertion);
    public override IEnumerable<BooleanResultBase<string>> CausesWithMetadata { get; } = Enumerable.Empty<BooleanResultBase<string>>();
    public override IEnumerable<BooleanResultBase<string>> UnderlyingWithMetadata { get; } = Enumerable.Empty<BooleanResultBase<string>>();
}