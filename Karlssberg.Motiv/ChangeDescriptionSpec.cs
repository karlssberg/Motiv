...
/// <summary>Represents a specification that changes the description of an underlying specification.</summary>
    ...
    SpecBase<TModel, TMetadata> underlyingSpec) : SpecBase<TModel, TMetadata>
{
    ...
    /// <summary>Determines if the model satisfies the specification.</summary>
