using Karlssberg.Motiv.Proposition.NestedSpecBuilders.Metadata;
using Karlssberg.Motiv.Proposition.NestedSpecBuilders.Reasons;

namespace Karlssberg.Motiv.Proposition.NestedSpecBuilders;
