...
public static class AnySatisfiedSpecExtensions
{
    ...
    ///     satisfied when any of the models in a collection are satisfied.
    /// </summary>
    /// <param name="spec">
    ///     The underlying specification that is to be converted into a new any-satisfied specification.
    /// </param>
    ...
    /// </summary>
    /// <param name="spec">
    ///     The underlying specification that is to be converted into a new any-satisfied
    ///     specification.
    /// </param>
    /// <typeparam name="TModel">
