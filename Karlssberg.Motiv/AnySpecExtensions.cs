...
public static class AnySatisfiedSpecExtensions
{
    ...
    ///     <paramref name="spec" />. Whether the specification is satisfied or not satisfied, the metadata is the aggregate of
    ...
    ///     the underlying results
    /// </returns>
    public static IYieldAllTrueMetadata<TModel, TMetadata, TUnderlyingMetadata> BuildAnySatisfiedSpec<TModel, TMetadata, TUnderlyingMetadata>(
