        ...
        IEquatable<bool>
{
    ...
    /// <summary>Gets every assertion yielded without filtering amy.</summary>
    public IEnumerable<string> AllAssertions =>
        this switch
        {
            ICompositeBooleanResult => Underlying.SelectMany(r => r.AllAssertions),
            _ => Assertions
        };
    ...
    /// <summary>Gets the sub-assertions involved in evaluating the result.</summary>
    public IEnumerable<string> AllSubAssertions => Underlying.GetAssertions();
