        ...
        IEnumerable<TMetadata>
{
    ...
    /// <summary>
    /// Gets a human readable description of the tree of conditions that make up this result.
    /// </summary>
    ...
    /// <summary>
    /// Determines whether the current BooleanResultBase object is equal to the specified boolean value.
    /// </summary>
    ...
    /// <summary>
    /// Determines whether the current BooleanResultBase object is equal to another BooleanResultBase object.
    /// </summary>
    ...
    /// <summary>
    /// Returns a new instance of <see cref="NotBooleanResult{TMetadata}"/> that represents the logical negation of the current instance.
    /// </summary>
    /// <returns>A new instance of <see cref="NotBooleanResult{TMetadata}"/> that represents the logical negation of the current instance.</returns>
    ...
    /// <summary>
    /// Defines the true operator for the <see cref="BooleanResultBase{TMetadata}"/> class.
    /// </summary>
    ...
    /// <summary>
    /// Defines the false operator for the <see cref="BooleanResultBase{TMetadata}"/> class.
    /// </summary>
    /// <param name="result">The <see cref="BooleanResultBase{TMetadata}"/> instance.</param>
    ...
    /// <summary>
    /// Determines whether two <see cref="BooleanResultBase{TMetadata}"/> objects are equal.
    /// </summary>
    ...
    /// <summary>
    /// Implements the inequality operator for comparing two instances of <see cref="BooleanResultBase{TMetadata}"/>.
    /// </summary>
    ...
    /// <summary>
    /// Defines an explicit conversion from <see cref="BooleanResultBase{TMetadata}"/> to <see cref="bool"/>.
    /// </summary>
    ...
    /// <summary>
    /// Gets the lowercase display text for true or false states.
    /// </summary>
