...
public static class AllSatisfiedSpecExtensions
{
    ...
    ///     satisfied when all of the models in a collection are satisfied.
    /// </summary>
    /// <param name="spec">
    ///     The underlying specification that is to be converted into a new all-satisfied specification.
    /// </param>
    /// <typeparam name="TModel">
    ///     The type of the model.  This will end up as the collection-type of the resultant specification.
    /// </typeparam>
    ...
    ///     into one that is satisfied when all of the models in a collection are satisfied.
    /// </summary>
    /// <param name="spec">
    ///     The underlying specification that is to be converted into a new all-satisfied
    ///     specification.
    /// </param>
    /// <typeparam name="TModel">
