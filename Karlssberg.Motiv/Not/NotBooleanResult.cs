...
/// <summary>
/// Represents the result of a logical NOT operation on a boolean result.
/// </summary>
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="NotBooleanResult{TMetadata}"/> class.
    /// </summary>
    ...
    /// <summary>
    /// Gets the operand result that is being negated.
    /// </summary>
    public BooleanResultBase<TMetadata> OperandResult { get; }

    /// <summary>
    /// Gets a value indicating whether the negation is satisfied.
    /// </summary>
    public override bool IsSatisfied { get; }

    /// <summary>
    /// Gets the description of the negation result.
    /// </summary>
