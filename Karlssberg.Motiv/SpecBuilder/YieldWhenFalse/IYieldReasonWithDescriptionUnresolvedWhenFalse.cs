...
public interface IYieldReasonWithDescriptionUnresolvedWhenFalse<TModel>
{
    ...
    IDescriptiveSpecFactory<TModel, string> YieldWhenFalse(string falseBecause);
    ...
    /// </param>
    /// <returns>A specification base.</returns>
    IDescriptiveSpecFactory<TModel, string> YieldWhenFalse(Func<TModel, string> falseBecause);
    ...
    /// </param>
    /// <returns>A specification base.</returns>
    IDescriptiveSpecFactory<TModel, string> YieldWhenFalse(Func<string> falseBecause);
}