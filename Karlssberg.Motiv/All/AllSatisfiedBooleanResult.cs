...
public sealed class AllSatisfiedBooleanResult<TModel, TMetadata, TUnderlyingMetadata> : BooleanResultBase<TMetadata>,
    IAllSatisfiedBooleanResult<TMetadata>
{
    /// <summary>
    /// Initializes a new instance of the
    /// <see cref="AllSatisfiedBooleanResult{TModel, TMetadata, TUnderlyingMetadata}" /> class.
    /// </summary>
