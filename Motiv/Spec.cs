...
/// <summary>
/// Represents a proposition for a model of type TModel that yields string-based metadata for explanations.
/// </summary>
/// <typeparam name="TModel">The type of the model.</typeparam>
public class Spec<TModel> : SpecBase<TModel, string>
{
    ...
    /// <summary>Gets the underlying specifications for this proposition. Returns an empty sequence as a default.</summary>
    public override IEnumerable<SpecBase> Underlying => Enumerable.Empty<SpecBase<TModel>>();

    /// <summary>Determines whether the specified model satisfies the proposition.</summary>
    /// <param name="model">The model to be checked against the proposition.</param>
    /// <returns>
    /// A BooleanResultBase containing the result of applying the proposition to the model and the associated
    /// metadata.
    /// </returns>
...
public static class Spec
{
    ...
    /// <param name="predicate">The predicate function to be used in the proposition.</param>
    /// <returns>
    /// A <see cref="TrueExpressionTreePropositionBuilder{TModel, BooleanResultBase{TMetadata}}" /> instance for further proposition
    /// building.
    /// </returns>
    ...
    /// <param name="predicate">The predicate function to be used in the proposition.</param>
    /// <returns>
    /// A <see cref="TrueExpressionTreePropositionBuilder{TModel, PolicyResultBase{TMetadata}}" /> instance for further proposition
    /// building.
    /// </returns>
