...
public readonly ref struct MultiAssertionExplanationFromPolicyResultHigherOrderPropositionFactory<TModel, TUnderlyingMetadata>(
    ...
    Func<HigherOrderPolicyResultEvaluation<TModel, TUnderlyingMetadata>, IEnumerable<string>> trueBecause,
