...
public readonly ref struct FalseMetadataFromPolicyHigherOrderPropositionBuilder<TModel, TMetadata, TUnderlyingMetadata>(
        ...
        IEnumerable<PolicyResult<TModel, TUnderlyingMetadata>>> causeSelector)
{
    ...
    public MetadataFromPolicyHigherOrderPropositionFactory<TModel, TMetadata, TUnderlyingMetadata> WhenFalse(TMetadata whenFalse) =>
        new(policy,
    ...
    /// <returns>An instance of <see cref="MetadataHigherOrderPropositionFactory{TModel,TMetadata,TUnderlyingMetadata}" />.</returns>
    public MetadataFromPolicyHigherOrderPropositionFactory<TModel, TMetadata, TUnderlyingMetadata> WhenFalse(
