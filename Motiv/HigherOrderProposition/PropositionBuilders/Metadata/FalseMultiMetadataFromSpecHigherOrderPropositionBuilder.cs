...
public readonly ref struct FalseMultiMetadataFromSpecHigherOrderPropositionBuilder<TModel, TMetadata, TUnderlyingMetadata>(
        ...
        IEnumerable<BooleanResult<TModel, TUnderlyingMetadata>>> causeSelector)
{
    ...
    public MultiMetadataFromSpecHigherOrderPropositionFactory<TModel, TMetadata, TUnderlyingMetadata> WhenFalse(TMetadata whenFalse) =>
        new(spec,
    ...
    /// <returns>An instance of <see cref="MetadataHigherOrderPropositionFactory{TModel,TMetadata,TUnderlyingMetadata}" />.</returns>
    public MultiMetadataFromSpecHigherOrderPropositionFactory<TModel, TMetadata, TUnderlyingMetadata> WhenFalse(
