...
public readonly ref struct FalseMultiMetadataFromPolicyResultPropositionBuilder<TModel, TMetadata, TUnderlyingMetadata>(
    ...
    Func<TModel, PolicyResultBase<TUnderlyingMetadata>, IEnumerable<TMetadata>> whenTrue)
{
    ...
    public MultiMetadataFromPolicyResultPropositionFactory<TModel, TMetadata, TUnderlyingMetadata> WhenFalse(
        TMetadata whenFalse) =>
        new(predicate,
            whenTrue,
