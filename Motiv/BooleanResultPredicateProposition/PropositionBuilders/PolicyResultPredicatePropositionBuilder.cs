...
public readonly ref struct PolicyResultPredicatePropositionBuilder<TModel, TUnderlyingMetadata>(
    Func<TModel, PolicyResultBase<TUnderlyingMetadata>> predicate)
{
    ...
    public FalseAssertionFromPolicyResultWithNamePropositionBuilder<TModel, TUnderlyingMetadata> WhenTrue(
        string trueBecause) =>
    ...
    public FalseAssertionExplanationFromPolicyResultPropositionBuilder<TModel, TUnderlyingMetadata> WhenTrue(
        Func<TModel, PolicyResultBase<TUnderlyingMetadata>, string> whenTrue)
    {
        whenTrue.ThrowIfNull(nameof(whenTrue));
        return new FalseAssertionExplanationFromPolicyResultPropositionBuilder<TModel, TUnderlyingMetadata>(
            predicate,
            whenTrue);
    }
    ...
    /// <returns>An instance of <see cref="FalseMetadataPropositionBuilder{TModel,TMetadata,TUnderlyingMetadata}" />.</returns>
    public FalseMetadataFromPolicyResultPropositionBuilder<TModel, TMetadata, TUnderlyingMetadata> WhenTrue<TMetadata>(
        TMetadata whenTrue)
    {
        whenTrue.ThrowIfNull(nameof(whenTrue));
        return new FalseMetadataFromPolicyResultPropositionBuilder<TModel, TMetadata, TUnderlyingMetadata>(
            predicate,
            (_, _) => whenTrue);
    }
    ...
    /// <param name="whenTrue">A function that generates a human-readable reason when the condition is true.</param>
    /// <returns>An instance of <see cref="FalseMetadataPropositionBuilder{TModel,TMetadata,TUnderlyingMetadata}" />.</returns>
    public FalseMultiMetadataFromPolicyResultPropositionBuilder<TModel, string, TUnderlyingMetadata> WhenTrueYield(
    ...
    /// <param name="whenTrue">A function that generates a human-readable reason when the condition is true.</param>
    /// <returns>An instance of <see cref="FalseMetadataPropositionBuilder{TModel,TMetadata,TUnderlyingMetadata}" />.</returns>
    public FalseMultiMetadataFromPolicyResultPropositionBuilder<TModel, TMetadata, TUnderlyingMetadata> WhenTrueYield<TMetadata>(
    ...
    public TrueHigherOrderFromPolicyResultPredicatePropositionBuilder<TModel, TUnderlyingMetadata> As(
    ...
    public PolicyBase<TModel, TUnderlyingMetadata> Create(string statement)
    {
        statement.ThrowIfNullOrWhitespace(nameof(statement));
        return new PolicyResultPredicateMetadataProposition<TModel, TUnderlyingMetadata, TUnderlyingMetadata>(
            predicate,
