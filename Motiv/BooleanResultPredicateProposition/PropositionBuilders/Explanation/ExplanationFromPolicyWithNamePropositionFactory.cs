...
public readonly ref struct ExplanationFromPolicyResultWithNamePropositionFactory<TModel, TUnderlyingMetadata>(
    ...
    Func<TModel, PolicyResultBase<TUnderlyingMetadata>, string> falseBecause)
{
    ...
    public PolicyBase<TModel, string> Create() =>
        new PolicyResultPredicateWithSingleAssertionProposition<TModel, TUnderlyingMetadata>(
            predicate,
            trueBecause,
            falseBecause,
    ...
    public PolicyBase<TModel, string> Create(string statement)
    {
        ...
        return new PolicyResultPredicateExplanationProposition<TModel,TUnderlyingMetadata>(
            predicate,
            trueBecause.ToFunc<TModel, PolicyResultBase<TUnderlyingMetadata>, string>(),
            falseBecause,
