...
public readonly ref struct FalseAssertionFromPolicyResultWithNamePropositionBuilder<TModel, TUnderlyingMetadata>(
    ...
    string trueBecause)
{
    ...
    public ExplanationFromPolicyResultWithNamePropositionFactory<TModel, TUnderlyingMetadata> WhenFalse(
        string falseBecause) =>
        new(predicate,
            trueBecause,
            (_, _) => falseBecause);
    ...
    public MultiAssertionExplanationFromPolicyResultWithNamePropositionFactory<TModel, TUnderlyingMetadata> WhenFalseYield(
