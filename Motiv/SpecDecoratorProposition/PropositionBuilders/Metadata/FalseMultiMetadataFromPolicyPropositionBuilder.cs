...
public readonly ref struct FalseMultiMetadataFromPolicyPropositionBuilder<TModel, TMetadata, TUnderlyingMetadata>(
    ...
    Func<TModel,PolicyResultBase<TUnderlyingMetadata>, IEnumerable<TMetadata>> whenTrue)
{
    ...
    public MultiMetadataFromPolicyPropositionFactory<TModel, TMetadata, TUnderlyingMetadata> WhenFalse(
        TMetadata whenFalse) =>
        new(spec,
            whenTrue,
