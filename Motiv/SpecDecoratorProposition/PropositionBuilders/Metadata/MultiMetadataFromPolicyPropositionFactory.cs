...
public readonly ref struct MultiMetadataFromPolicyPropositionFactory<TModel, TMetadata, TUnderlyingMetadata>(
    ...
    Func<TModel, PolicyResultBase<TUnderlyingMetadata>, IEnumerable<TMetadata>> whenFalse)
{
    ...
    public SpecBase<TModel, TMetadata> Create(string statement) =>
        new PolicyDecoratorMultiMetadataProposition<TModel, TMetadata, TUnderlyingMetadata>(
            spec,
            whenTrue,
            whenFalse,
