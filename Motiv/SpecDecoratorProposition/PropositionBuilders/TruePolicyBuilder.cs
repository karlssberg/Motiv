...
public readonly ref struct TruePolicyBuilder<TModel, TUnderlyingMetadata>(
    PolicyBase<TModel, TUnderlyingMetadata> spec)
{
    ...
    /// </para>
    /// </remarks>
    public FalseMetadataPolicyBuilder<TModel, TMetadata, TUnderlyingMetadata> WhenTrue<TMetadata>(
    ...
    /// <returns>An instance of <see cref="FalseMetadataPropositionBuilder{TModel,TMetadata,TUnderlyingMetadata}" />.</returns>
    public FalseMultiMetadataFromPolicyPropositionBuilder<TModel, TMetadata, TUnderlyingMetadata> WhenTrueYield<TMetadata>(
    ...
    /// <param name="trueBecause">A function that generates a human-readable reason when the condition is true.</param>
    /// <returns>An instance of <see cref="FalseAssertionPropositionBuilder{TModel,TUnderlyingMetadata}" />.</returns>
    public FalseAssertionPolicyBuilder<TModel, TUnderlyingMetadata> WhenTrue(
    ...
    /// <param name="trueBecause">A function that generates a human-readable reason when the condition is true.</param>
    /// <returns>An instance of <see cref="FalseAssertionPropositionBuilder{TModel,TUnderlyingMetadata}" />.</returns>
    public FalseMultiMetadataFromPolicyPropositionBuilder<TModel, string, TUnderlyingMetadata> WhenTrueYield(
    ...
    public TrueHigherOrderFromPolicyPropositionBuilder<TModel, TUnderlyingMetadata> As(
    ...
    public SpecBase<TModel, TUnderlyingMetadata> Create(string statement) =>
        new PolicyDecoratorMultiMetadataProposition<TModel, TUnderlyingMetadata, TUnderlyingMetadata>(
            spec,
