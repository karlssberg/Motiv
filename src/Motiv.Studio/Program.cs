...
// quietly into a quarantined rule's compiled default — behaviour nobody approved — is worse than
// Studio refusing to boot until a stale row is repaired.
...
/// <summary>The model Studio's rules are evaluated against.</summary>
/// <remarks>
