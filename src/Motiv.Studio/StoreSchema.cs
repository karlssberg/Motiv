...
/// and no database server, so Studio creates its own schema on startup — but it is also the
/// headline two-replica demonstration, and two replicas start at the same time.
/// </summary>
/// <remarks>
/// <para>
...
/// "table already exists". Scale Studio to two instances over a shared volume, or point two at one
