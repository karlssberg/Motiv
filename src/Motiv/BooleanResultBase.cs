    ...
    : IEquatable<BooleanResultBase>, IEquatable<bool>
{
    ...
    private IEnumerable<string>? _underlyingReasons;
    private IEnumerable<BooleanResultBase>? _underlyingAssertionSources;
    private IEnumerable<BooleanResultBase>? _underlyingAllAssertionSources;
    private IEnumerable<string>? _rootAssertions;
    private IEnumerable<string>? _allRootAssertions;
    ...
    /// </summary>
    public IEnumerable<string> UnderlyingReasons => _underlyingReasons ??= UnderlyingExpressionResults.Select(result => result.Reason).ToArray();
    ...
    public IEnumerable<string> Assertions => _assertions ??= Explanation.Assertions.DistinctWithOrderPreserved().ToArray();
    ...
    public IEnumerable<string> RootAssertions => _rootAssertions ??= this.GetRootAssertions().ToArray();

    /// <summary>Gets all the underlying assertions generated by the evaluation.</summary>
    public IEnumerable<string> AllRootAssertions => _allRootAssertions ??= this.GetAllRootAssertions().ToArray();
    ...
    public IEnumerable<BooleanResultBase> UnderlyingAssertionSources =>
        _underlyingAssertionSources ??= Causes
            .SelectMany(booleanResult =>
    ...
    public IEnumerable<BooleanResultBase> UnderlyingAllAssertionSources =>
        _underlyingAllAssertionSources ??= Underlying
            .SelectMany(booleanResult =>
                booleanResult is IBooleanOperationResult
