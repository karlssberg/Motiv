...
public readonly struct AsyncMultiAssertionExplanationWithNamePropositionFactory<TModel>(
    ...
    [FluentMethod("WhenFalseYield")]Func<TModel, IEnumerable<string>> falseBecause)
{
    ...
    /// </summary>
    /// <returns>An instance of <see cref="AsyncSpecBase{TModel, TMetadata}" />.</returns>
