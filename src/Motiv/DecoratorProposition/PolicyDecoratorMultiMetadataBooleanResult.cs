...
/// <summary>
///     Represents the result of a policy-decorator multi-metadata evaluation. The metadata resolver is only invoked
...
internal sealed class PolicyDecoratorMultiMetadataBooleanResult<TModel, TMetadata, TUnderlyingMetadata>(
    ...
    : BooleanResultBase<TMetadata>
{
    ...
    public override MetadataNode<TMetadata> MetadataTier =>
        field ??= new MetadataNode<TMetadata>(metadataResolver(model, policyResult),
