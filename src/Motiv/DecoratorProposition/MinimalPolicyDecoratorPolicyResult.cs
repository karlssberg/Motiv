...
/// <summary>
///     Represents the result of a minimal policy decorator evaluation. The underlying result supplies the value and
///     explanation directly, and all derived state is cached in fields to avoid per-evaluation closure allocations.
/// </summary>
/// <param name="predicateResult">The underlying policy result being decorated.</param>
/// <param name="specDescription">The description of the proposition.</param>
/// <typeparam name="TMetadata">The type of the metadata.</typeparam>
internal sealed class MinimalPolicyDecoratorPolicyResult<TMetadata>(
    PolicyResultBase<TMetadata> predicateResult,
    ...
    : PolicyResultBase<TMetadata>
{
    ...
    /// <inheritdoc />
    public override TMetadata Value => predicateResult.Value;

    /// <summary>
    ///     Gets the metadata tier of the result.
    /// </summary>
    public override MetadataNode<TMetadata> MetadataTier =>
        field ??= new MetadataNode<TMetadata>(predicateResult.Value, UnderlyingResults);
