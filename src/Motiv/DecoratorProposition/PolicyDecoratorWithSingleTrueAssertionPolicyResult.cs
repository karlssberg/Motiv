...
/// <summary>
///     Represents the result of a policy-decorator policy evaluation with a single (constant) true assertion. The
...
///     purposes.
/// </summary>
/// <param name="underlyingResult">The underlying policy result that was decorated.</param>
...
internal sealed class PolicyDecoratorWithSingleTrueAssertionPolicyResult<TModel, TUnderlyingMetadata>(
