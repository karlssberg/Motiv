...
public static class MotivLimits
{
    ...
    /// <b>attaching a listener must not change what an evaluation decides</b>. Charged, merely
    /// subscribing to the <c>Motiv</c> source could push a composition past this limit — and, for an
    /// evaluation nested inside a running one, do it at an unrelated node
