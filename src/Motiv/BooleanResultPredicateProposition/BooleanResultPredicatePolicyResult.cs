...
///     <see cref="BooleanResultPredicateProposition{TModel,TMetadata,TUnderlyingMetadata}" /> evaluation. The metadata
...
internal sealed class BooleanResultPredicatePolicyResult<TModel, TMetadata, TUnderlyingMetadata>(
    TModel model,
