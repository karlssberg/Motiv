...
/// <param name="whenTrue">The function that returns the metadata to yield when the predicate is true.</param>
/// <param name="whenFalse">The function that returns the metadata to yield when the predicate is false.</param>
