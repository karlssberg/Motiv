...
/// </summary>
/// <param name="predicate">The predicate function that evaluates the model to a <see cref="BooleanResultBase{TMetadata}" />.</param>
...
public readonly partial struct MinimalBooleanResultPredicatePropositionFactory<TModel, TMetadata>(
