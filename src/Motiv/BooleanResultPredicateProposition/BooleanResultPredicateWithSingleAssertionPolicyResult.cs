...
///     <see cref="BooleanResultPredicateWithSingleAssertionProposition{TModel,TUnderlyingMetadata}" /> evaluation. The
...
internal sealed class BooleanResultPredicateWithSingleAssertionPolicyResult<TModel, TUnderlyingMetadata>(
    TModel model,
