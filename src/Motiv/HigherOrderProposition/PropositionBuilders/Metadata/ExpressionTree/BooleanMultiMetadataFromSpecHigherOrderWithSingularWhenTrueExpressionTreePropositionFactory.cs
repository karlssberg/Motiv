...
public readonly struct BooleanMultiMetadataFromSpecHigherOrderWithSingularWhenTrueExpressionTreePropositionFactory<TModel, TMetadata>(
    ...
    [FluentMethod("WhenFalseYield")]Func<HigherOrderBooleanResultEvaluation<TModel, string>, IEnumerable<TMetadata>> whenFalse)
{
    ...
    public SpecBase<IEnumerable<TModel>, TMetadata> Create(string statement)
    {
        ...
        return new HigherOrderFromExpressionTreeMultiMetadataProposition<TModel, TMetadata, bool>(
            expression,
