...
public class SpecDecoratorWithSingleTrueAssertionPolicyResultTests
{
    ...
    private static SpecDecoratorWithSingleTrueAssertionPolicyResult<bool, string> CompatibleDecorator(
    ...
    private static SpecDecoratorWithSingleTrueAssertionPolicyResult<bool, int> IncompatibleDecorator(
