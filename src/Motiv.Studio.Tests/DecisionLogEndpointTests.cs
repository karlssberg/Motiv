...
public class DecisionLogEndpointTests
{
    ...
    {
        // Arrange — loyalty-discount is Studio's document-default rule, and therefore the only
    ...
    public async Task Should_refuse_to_audit_a_rule_running_on_a_compiled_default()
    {
        ...
        // Assert — Studio registers a capture posture for Customer, so this is allowed, and the
