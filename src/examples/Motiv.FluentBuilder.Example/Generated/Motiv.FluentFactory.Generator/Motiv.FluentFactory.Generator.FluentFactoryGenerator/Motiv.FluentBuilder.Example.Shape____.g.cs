namespace Motiv.FluentBuilder.Example
{
        ...
        where T : System.Numerics.INumber<T>
    {
        ...
        public static Step_0__Motiv_FluentBuilder_Example_Shape____<T> WithWidth(in T width)
        {
            return new Step_0__Motiv_FluentBuilder_Example_Shape____<T>(width);
        }
        ...
        /// </summary>
        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        public static Step_3__Motiv_FluentBuilder_Example_Shape____<T> WithRadius(in T radius)
        {
            return new Step_3__Motiv_FluentBuilder_Example_Shape____<T>(radius);
        }
    }
    ...
    ///     <seealso cref="Motiv.FluentBuilder.Example.Square{T}"/>
    /// </summary>
    public struct Step_0__Motiv_FluentBuilder_Example_Shape____<T> where T : System.Numerics.INumber<T>
    {
        private readonly T _width__parameter;
        internal Step_0__Motiv_FluentBuilder_Example_Shape____(in T width)
        {
        ...
        /// </summary>
        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        public Step_1__Motiv_FluentBuilder_Example_Shape____<T> WithHeight(in T height)
        {
            return new Step_1__Motiv_FluentBuilder_Example_Shape____<T>(this._width__parameter, height);
        }
    ...
    ///     <seealso cref="Motiv.FluentBuilder.Example.Rectangle{T}"/>
    /// </summary>
    public struct Step_1__Motiv_FluentBuilder_Example_Shape____<T> where T : System.Numerics.INumber<T>
    {
        private readonly T _width__parameter;
        private readonly T _height__parameter;
        internal Step_1__Motiv_FluentBuilder_Example_Shape____(in T width, in T height)
        {
            this._width__parameter = width;
        ...
        /// </summary>
        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        public Step_2__Motiv_FluentBuilder_Example_Shape____<T> WithDepth(in T depth)
        {
            return new Step_2__Motiv_FluentBuilder_Example_Shape____<T>(this._width__parameter, this._height__parameter, depth);
        }
    ...
    ///     <seealso cref="Motiv.FluentBuilder.Example.Cuboid{T}"/>
    /// </summary>
    public struct Step_2__Motiv_FluentBuilder_Example_Shape____<T> where T : System.Numerics.INumber<T>
    {
        private readonly T _width__parameter;
        private readonly T _height__parameter;
        private readonly T _depth__parameter;
        internal Step_2__Motiv_FluentBuilder_Example_Shape____(in T width, in T height, in T depth)
        {
            this._width__parameter = width;
            this._height__parameter = height;
    ...
    ///     <seealso cref="Motiv.FluentBuilder.Example.Circle{T}"/>
    /// </summary>
    public struct Step_3__Motiv_FluentBuilder_Example_Shape____<T> where T : System.Numerics.INumber<T>
    {
        private readonly T _radius__parameter;
        internal Step_3__Motiv_FluentBuilder_Example_Shape____(in T radius)
        {
