...
public struct Step_0__Shape<T> where T : System.Numerics.INumber<T>
{
    ...
    /// </summary>
    [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
    public Step_1__Shape<T> WithHeight(in T height)
    {
        return new Step_1__Shape<T>(this._width__parameter, height);
    }
...
public struct Step_1__Shape<T> where T : System.Numerics.INumber<T>
{
    ...
    internal Step_1__Shape(in T width, in T height)
    {
        this._width__parameter = width;
    ...
    /// </summary>
    [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
    public Step_2__Shape<T> WithDepth(in T depth)
    {
        return new Step_2__Shape<T>(this._width__parameter, this._height__parameter, depth);
    }
...
public struct Step_2__Shape<T> where T : System.Numerics.INumber<T>
{
    ...
    internal Step_2__Shape(in T width, in T height, in T depth)
    {
        this._width__parameter = width;
        this._height__parameter = height;
