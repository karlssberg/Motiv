...
Shape.WithWidth(10m).WithHeight(20).CreateRectangle();
Shape.WithWidth(10d).WithHeight(20).CreateDiamond();
Shape.WithWidth(10f).WithHeight(20).WithDepth(30).CreateCuboid();
