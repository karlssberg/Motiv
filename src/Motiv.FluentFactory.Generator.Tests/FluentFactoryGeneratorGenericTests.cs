...
public class FluentFactoryGeneratorGenericTests
{
    ...
    [Fact]
    public async Task Should_generate_a_generic_root_fluent_factory_type_with_constraints_when_the_original_has_constraints()
    {
        const string code =
            """
            using System;
    ...
    [Fact]
    public async Task Should_generate_a_generic_target_types_with_constraints_when_the_root_fluent_factory_type_is_non_generic()
    {
        const string code =
            """
            using System;
    ...
    [Fact]
    public async Task Should_generate_a_generic_target_types_with_constraints_when_the_root_fluent_factory_type_is_non_generic_and_there_are_multiple_fluent_constructor_parameters()
    {
        const string code =
            """
            using System;
