...
public class AtMostNSatisfiedSpecificationTests
{
    [Theory]
        ...
        string model)
    {
        ...
        act.Should().Throw<SpecificationException>().Where(ex => ex.Message.Contains("AtMostNSatisfiedSpecification<Object, String>"));
