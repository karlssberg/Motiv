...
public class MinimalSpecDecoratorBooleanResultTests
{
    private static BooleanResultBase<string> CreateUnderlying(bool satisfied) =>
        Spec.Build((bool m) => m)
    ...
    private static MinimalSpecDecoratorBooleanResult<string> CreateDecorator(bool satisfied) =>
    ...
    public void Underlying_ShouldContainTheUnderlyingResult(bool satisfied)
    {
        ...
        var result = new MinimalSpecDecoratorBooleanResult<string>(underlying, new SpecDescription("decorated"));
    ...
    public void MetadataTier_ShouldExposeUnderlyingValues(bool satisfied, string expected)
    {
        var result = CreateDecorator(satisfied);
    ...
    [InlineAutoData(true)]
    [InlineAutoData(false)]
    public void Description_ShouldBeCachedAcrossReads(bool satisfied)
    {
        var result = CreateDecorator(satisfied);

        var first = result.Description;
        var second = result.Description;
