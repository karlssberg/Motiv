...
public class PolicyDecoratorMultiMetadataBooleanResultTests
{
    ...
    private static PolicyDecoratorMultiMetadataBooleanResult<bool, int, int> CompatibleDecorator(
    ...
    private static PolicyDecoratorMultiMetadataBooleanResult<bool, string, int> IncompatibleDecorator(
        PolicyResultBase<int> underlying) =>
