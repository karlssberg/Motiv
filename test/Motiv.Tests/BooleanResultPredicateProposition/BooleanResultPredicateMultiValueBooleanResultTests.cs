...
/// <summary>
/// Exercises <c>BooleanResultPredicateMultiValueBooleanResult&lt;TModel, TMetadata, TUnderlyingMetadata&gt;</c>,
/// produced by a multi-value metadata proposition (<c>WhenTrueYield + WhenFalseYield + Create(name)</c>) whose
/// predicate is typed to return a <see cref="BooleanResultBase{TMetadata}"/>. The underlying metadata type is varied
/// relative to the replacement metadata type to cover both arms of the value-bearing collection casts.
/// </summary>
public class BooleanResultPredicateMultiValueBooleanResultTests
{
