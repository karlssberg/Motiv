...
| [Expression Leaves](./live-rules/expressions.md)                          | A small owned language for a leaf's condition &mdash; fields, parameters, literals, and a closed set of collection and string methods &mdash; checked in the editor and bound through `Spec.From`. |
