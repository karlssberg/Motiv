...
| [AndAlso()](./operators/AndAlso.md) | `left.AndAlso(right)` <br />or<br />`left && right` ([results](xref:Motiv.BooleanResultBase`1) only)                       | Performs a logical AND on two propositions/results. The short-circuiting `&&` operator overload is only available for results. |
| [Or()](./operators/Or.md)           | `left.Or(right)`  <br />or<br /> <code>left &#124; right</code>                                                            | Performs a logical OR on two propositions/results.                  |
| [OrElse()](./operators/OrElse.md)   | `left.OrElse(right)`  <br />or<br /><code>left &#124;&#124; right</code>  ([results](xref:Motiv.BooleanResultBase`1) only) | Performs a logical OR on two propositions/results. The short-circuiting `||` operator overload is only available for results. |
...
| Method                                                               | Description                                                                                                                                                                                                   |
|----------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Where&lt;T&gt;()](./collections/generic/Where.md)                   | Filters a collection using a proposition instead of a predicate function.                                                                                                                                    |
